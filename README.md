...
You will have to install `chromedriver` separately:
...
When debugging it can be useful to run tests in a browser: set the `BROWSER` variable to `true` e.g. `BROWSER=true make run`
