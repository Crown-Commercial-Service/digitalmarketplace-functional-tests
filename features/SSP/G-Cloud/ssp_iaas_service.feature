...
Feature: Submitting a new service for IaaS
  ...
  Scenario: Verify text on summary page
    ...
    And Summary table row 'Data protection between user device and service' under the heading 'Data-in-transit protection' should contain 'Encrypted PSN service, assured by Independent validation of assertion'
    ...
    And Summary table row 'Data protection between services' under the heading 'Data-in-transit protection' should contain 'Encrypted PSN service, assured by CESG-assured components'
    ...
    And Summary table row 'Interconnection method provided' under the heading 'External interface protection' should contain 'Encrypted PSN service'
