...
export DM_PRODUCTION_ADMIN_MANAGER_USER_EMAIL=${DM_PRODUCTION_ADMIN_MANAGER_USER_EMAIL:=production-admin-manager-user@example.gov.uk}
export DM_PRODUCTION_ADMIN_MANAGER_USER_PASSWORD=${DM_PRODUCTION_ADMIN_MANAGER_USER_PASSWORD:=Password1234}

export DM_PRODUCTION_ADMIN_FRAMEWORK_MANAGER_USER_EMAIL=${DM_PRODUCTION_ADMIN_FRAMEWORK_MANAGER_USER_EMAIL:=production-admin-framework-manager-user@example.gov.uk}
