...
export DM_PRODUCTION_ADMIN_CCS_DATA_CONTROLLER_USER_EMAIL=${DM_PRODUCTION_ADMIN_CCS_DATA_CONTROLLER_USER_EMAIL:=production-admin-ccs-data-controller-user@user.marketplace.team}
export DM_PRODUCTION_ADMIN_CCS_DATA_CONTROLLER_USER_PASSWORD=${DM_PRODUCTION_ADMIN_CCS_DATA_CONTROLLER_USER_PASSWORD:=Password1234}
