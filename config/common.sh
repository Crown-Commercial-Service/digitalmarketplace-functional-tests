...
export DM_SUPPLIER_USER_EMAIL=${DM_SUPPLIER_USER_EMAIL:=production-supplier-user@example.com}
...
export DM_BUYER_USER_EMAIL=${DM_BUYER_USER_EMAIL:=production-buyer-user@example.gov.uk}
export DM_BUYER_USER_PASSWORD=${DM_BUYER_USER_PASSWORD:=Password1234}

export DM_ADMIN_USER_EMAIL=${DM_ADMIN_USER_EMAIL:=production-admin-user@user.marketplace.team}
export DM_ADMIN_USER_PASSWORD=${DM_ADMIN_USER_PASSWORD:=Password1234}

export DM_ADMIN_CCS_CATEGORY_USER_EMAIL=${DM_ADMIN_CCS_CATEGORY_USER_EMAIL:=production-admin-ccs-category-user@user.marketplace.team}
export DM_ADMIN_CCS_CATEGORY_USER_PASSWORD=${DM_ADMIN_CCS_CATEGORY_USER_PASSWORD:=Password1234}

export DM_ADMIN_CCS_SOURCING_USER_EMAIL=${DM_ADMIN_CCS_SOURCING_USER_EMAIL:=production-admin-ccs-sourcing-user@user.marketplace.team}
export DM_ADMIN_CCS_SOURCING_USER_PASSWORD=${DM_ADMIN_CCS_SOURCING_USER_PASSWORD:=Password1234}

export DM_ADMIN_MANAGER_USER_EMAIL=${DM_ADMIN_MANAGER_USER_EMAIL:=production-admin-manager-user@user.marketplace.team}
export DM_ADMIN_MANAGER_USER_PASSWORD=${DM_ADMIN_MANAGER_USER_PASSWORD:=Password1234}

export DM_ADMIN_FRAMEWORK_MANAGER_USER_EMAIL=${DM_ADMIN_FRAMEWORK_MANAGER_USER_EMAIL:=production-admin-framework-manager-user@user.marketplace.team}
